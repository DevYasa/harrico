// src/pages/custom-designs/CustomDesigns.jsx
  ...
  const inspirationCategories = [
    {
      ...
      link: '/custom-designs/engagement'
    },
    {
      ...
      link: '/custom-designs/anniversary'
    },
    {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mt-8 md:mt-12">
            ...
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-md">
              ...
              <Link 
                ...
                className="text-sm text-[#b9a16b] tracking-wider uppercase relative inline-flex items-center"
              >
                EXPLORE CATEGORIES <span className="ml-1">›</span>
              </Link>
            </div>
