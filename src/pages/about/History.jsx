      ...
      <section className="py-12 md:py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-8 md:mt-12">
            <div className="text-center p-6 md:p-8 border border-transparent hover:border-[#b9a16b] transition-colors duration-500">
              ...
              <h3 className="text-lg md:text-xl font-serif mb-3 md:mb-4">Excellence</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center p-6 md:p-8 border border-transparent hover:border-[#b9a16b] transition-colors duration-500">
              ...
              <h3 className="text-lg md:text-xl font-serif mb-3 md:mb-4">Heritage</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center p-6 md:p-8 border border-transparent hover:border-[#b9a16b] transition-colors duration-500">
              ...
              <h3 className="text-lg md:text-xl font-serif mb-3 md:mb-4">Integrity</h3>
              <p className="text-gray-700">
