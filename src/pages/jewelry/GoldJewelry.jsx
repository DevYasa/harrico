...
import GoldJewelryHeroImage from '../../assets/images/collections/sapphire-jewelry.jpg';
...
const GoldJewelry = () => {
  ...
  const goldCategories = [
    {
      ...
      image: '/assets/images/collections/jewelry/22kt-gold.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/collections/jewelry/18kt-yellow-gold.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/collections/jewelry/18kt-white-gold.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/collections/jewelry/14kt-yellow-gold.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/collections/jewelry/14kt-white-gold.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/collections/jewelry/9kt-yellow-gold.jpg',
    ...
    },
    {
      ...
      image: '/assets/images/collections/jewelry/9kt-white-gold.jpg',
  ...
  return (
    <div className="bg-white">
      ...
      <AnimatedPageHeader 
        title="Gold Jewelry" 
        subtitle="Timeless elegance crafted in the finest gold, showcasing our exceptional Ceylon gemstones"
        backgroundImage={GoldJewelryHeroImage}
      />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-8 md:mt-12">
            {jewelryTypes.map((item, index) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-serif mb-2 text-center">{item.type}</h3>
            ...
            {goldCategories.map((category) => (
              ...
              >
                ...
                <div className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-serif mb-2">{category.name}</h3>
            ...
            <div className="w-full md:w-1/2">
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-white p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                  <h4 className="text-base md:text-lg font-serif mb-2 md:mb-3">22KT Gold (91.7% Pure)</h4>
                ...
                <div className="bg-white p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                  <h4 className="text-base md:text-lg font-serif mb-2 md:mb-3">18KT Gold (75% Pure)</h4>
                ...
                <div className="bg-white p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                  <h4 className="text-base md:text-lg font-serif mb-2 md:mb-3">14KT Gold (58.3% Pure)</h4>
                  <p className="text-sm text-gray-700">Durable and practical gold with excellent value, ideal for everyday jewelry.</p>
                </div>
                <div className="bg-white p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                  <h4 className="text-base md:text-lg font-serif mb-2 md:mb-3">9KT Gold (37.5% Pure)</h4>
      ...
      <section className="py-12 md:py-16 lg:py-24 bg-[#08081a] text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-serif mb-4 md:mb-6">Custom Gold Jewelry</h2>
